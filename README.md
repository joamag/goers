...
Random set of tests under the go language. These tests are meant to serve as an introduction to the language and no practical use case should be solved.
